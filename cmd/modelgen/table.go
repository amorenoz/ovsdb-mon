...
//func (g *TableGenerator) PrintApi() {
//	// API struct
//	tableStruct := g.TableTypeName()
//	apiStruct := g.TableApiStruct()
//	g.Printf("type %s struct {\n", apiStruct)
//	g.Printf("\tclient goovn.Client\n") // TODO Deal with dependencies
//	g.Printf("}\n")
//	// Get
//
//	g.Printf("func (a %s) Get(uuid string) (*%s, error) {\n", apiStruct, tableStruct)
//	g.Printf("\tvar obj %s\n", tableStruct)
//	g.Printf("\tif err := a.client.Get(&obj, uuid); err != nil {\n")
...
//
//	// List
//	g.Printf("func (a %s) List() (*[]%s, error) {\n", apiStruct, tableStruct)
//	g.Printf("\tvar obj []%s\n", tableStruct)
//	g.Printf("\tif err := a.client.List(&obj); err != nil {\n")
//	g.Printf("\t\treturn nil, err\n")
//	g.Printf("\t}\n")
//	g.Printf("\treturn &obj, nil\n")
//	g.Printf("}\n")
...
//
//	// Add
//	g.Printf("func (a %s) Add(obj *%s) (*goovn.OvnCommand, error) {\n", apiStruct, tableStruct)
//	g.Printf("\treturn a.client.Add(obj)\n")
//	g.Printf("}\n")
//}
